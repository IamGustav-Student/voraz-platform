...
const IMAGES_BASE64 = {
    burger: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA...", // Truncado por brevedad, usaré el dato real
    pizza: "...",
    fries: "...",
    drinks: "...",
    dessert: "..."
...
export async function runImageFix() {
    // Configurar Cloudinary (usando las ya existentes en process.env)
    cloudinary.config({
